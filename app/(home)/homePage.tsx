  ...
  return (
    <>
      ...
      <p className="text-slate-500 mt-5">
        {formatNumber({ value: Number(usage) + currentUses })} Learning plans
        generated so far.
      </p>
      <form className="max-w-xl w-full" onSubmit={onSubmit}>
        <div className="flex mt-10 items-center space-x-3">
          ...
          <p className="text-left font-medium">
            Describe what would you learn or upload a file.
          </p>
        </div>
        <textarea
          value={content}
          ...
          placeholder={"e.g. I want to learn how to learn"}
        />
          ...
          <>
            ...
            >
              {isLoading ? (
                ...
                <span>Personalised Learning Pathway Challenge &rarr;</span>
              )}
            </button>
          </>
        ) : (
